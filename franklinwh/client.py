...
class Mode:
    ...
    @classmethod
    def get_by_id(cls, id: int) -> Mode:
        """Get a Mode instance by its runtime ID.

        Parameters
        ----------
        id : int
            The runtime ID of the mode.

        Returns:
        -------
        Mode
            An instance of Mode corresponding to the given runtime ID.

        Raises:
        ------
        ValueError
            If the runtime ID is unknown.
        """
